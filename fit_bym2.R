...
bym2_stanfit <- stan("bym2.stan", 
                    data=list(N=N, N_edges=N_edges, node1=node_1, node2=node_2, y=count, 
                              x=design_mtx, E=E, scaling_factor=scaling_factor), 
                    control=list(max_treedepth=20, adapt_delta=0.97, stepsize=0.1),
                    chains=1, warmup=500, iter=1000, save_warmup=FALSE);
